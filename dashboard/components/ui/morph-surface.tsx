...
export function MorphSurface({
  ...
  const isFixed = showFeedback;

  return (
    <div
      className={cn(
        isFixed
          ? "fixed inset-0 flex items-center justify-center bg-black/60 backdrop-blur-[1.5px] z-50 transition-all duration-300 animate-fade-in"
    ...
    >
      <motion.div
        ...
        style={{
          maxWidth: isFixed ? "calc(100vw - 2rem)" : undefined,
          maxHeight: isFixed ? "calc(100vh - 2rem)" : undefined,
        }}
        initial={false}
        animate={{
