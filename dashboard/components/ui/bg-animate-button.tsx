  ...
  ],
  {
    variants: {
      ...
      gradient: {
        ...
        oxblood: "bg-[conic-gradient(from_90deg_at_50%_50%,#5e1414_0%,#a61f1f_50%,#5e1414_100%)] ",
      },
    },
    compoundVariants: [
      {
...
export interface UnifiedButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  gradient?: "sunrise" | "ocean" | "candy" | "default" | "forest" | "sunset" | "nebula" | "oxblood";
}
